  ...
  return (
    <div className="App">
      <Routes>
        ...
        <Route path="/detailProfile/:id" element={
          <DetailProfile 
            setValidateState={setValidateState} 
            setCurrentUserStore2={setCurrentUserStore2}
          />
        ...
        <Route path="/newRegistroApplicant" element={
          <NewRegistroApplicant
            setCurrentUserStore2={setCurrentUserStore2}
            setValidateState={setValidateState}
        ...
        <Route path="/newRegistroCompany" element={
            <NewRegistroCompany
              setCurrentUserStore2={setCurrentUserStore2}
              setValidateState={setValidateState}
              setCurrentUserStore={setCurrentUserStore}
        ...
        <Route path="/loginApplicant" element={
            <LoginApplicant
              setValidateState={setValidateState}
              setCurrentUserStore={setCurrentUserStore}
            />
        ...
        <Route path="/ServerDevelop" element={
          <ServerMaintenance/>
        }/>
        ...
        <Route path="/registroini-empresa" element={
            <FormRegisterEmpresa
              setCurrentUserStore2={setCurrentUserStore2}
              setCurrentUserStore={setCurrentUserStore}
              setValidateState={setValidateState}
        ...
        <Route path="/plansAndPrices" element={
          <PlansAndPrices
            setValidateState={setValidateState}
            setCurrentUserStore2={setCurrentUserStore2}
          />
        ...
        <Route element={<ProtectedRoute isAutenticate={validate} /> /*Todos*/}>
          <Route path="/empleoDetail/:detailId" element={
            <EmpleoDetail
              setValidateState={setValidateState}
              setCurrentUserStore2={setCurrentUserStore2}
            />
          }/>
          <Route path="/profiles-company" element={
            <ProfilesCompany
              setValidateState={setValidateState}
              setCurrentUserStore2={setCurrentUserStore2}
            />
        ...
        <Route element={<ProtectedRoute isAutenticate={ validate && (userType2?.profile === "Company" || userType2?.profile === "Admin")}/> /*Empresa*/}>
          ...
          <Route path="/registro-vacante" element={
            <FormVacante
              setValidateState={setValidateState}
              setCurrentUserStore2={setCurrentUserStore2}
            />
          ...
          <Route path="/perfil-company" element={
            <PerfilCompany
              setValidateState={setValidateState}
              setCurrentUserStore2={setCurrentUserStore2}
            />
        ...
        <Route element={<ProtectedRoute isAutenticate={validate && (userType2?.profile === "Applicant" || userType2?.profile === "Admin")}/> /*Empleado*/}>
          <Route path="/registro-cv" element={
            <FormCv
              setValidateState={setValidateState}
              setCurrentUserStore2={setCurrentUserStore2}
            />
          ...
          <Route path="/registro-experiencia" element={
            <FormRegistroExperincia
              setValidateState={setValidateState}
              setCurrentUserStore2={setCurrentUserStore2}
            />
          }/>
          <Route path="/registro-estudio" element={
            <FormRegistroEstudio
              setValidateState={setValidateState}
              setCurrentUserStore2={setCurrentUserStore2}
            />
